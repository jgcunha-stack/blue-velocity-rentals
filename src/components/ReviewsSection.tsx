    ...
    <section className="py-12 md:py-20 lg:py-28 bg-secondary relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-[100px] relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {reviews.map((review, index) => (
            <motion.div
              ...
              className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 sm:p-8 relative group hover:border-accent/30 transition-all duration-300"
            >
              {/* Quote icon */}
        ...
        <motion.div
          ...
          className="flex flex-wrap justify-center gap-8 md:gap-16 mt-12 md:mt-16 pt-8 border-t border-white/10"
        >
