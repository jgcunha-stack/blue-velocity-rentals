        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
          ...
          <div className="relative rounded-3xl overflow-hidden min-h-[400px] lg:min-h-[500px]">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-white leading-tight mb-3">
                Atendimento que
                <br />
                <span className="text-accent">gera confiança</span>
              </h2>
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-6">
            {benefits.map((benefit, index) => (
              <div 
                key={index} 
                className="bg-background rounded-2xl p-5 md:p-6 shadow-sm border border-border/50 hover:shadow-md transition-shadow"
              >
